def add_base_arguments(parser):
    parser.add_argument(
        "--dataset", type=str, default="merge_alarm", help="default: merge_alarm"
    )
    parser.add_argument(
        "--kind",
        type=str,
    ...
    parser.add_argument("--previous_model_dir", type=str, default=None,
                        help="set as alarm_test means checkpoints/alarm_test")
...
def add_subparser_arguments(model, subparsers):
    ...
    if model == "ODE-RNN":
        ...
        sub_parser.add_argument(
            "--method", type=str, default="dopri5", help="Method for solving ODE."
        )
        sub_parser.add_argument(
        ...
        sub_parser.add_argument(
            "--atol", type=float, default=1e-5, help="default: 1e-9"
        )
        sub_parser.add_argument(
            "--rtol", type=float, default=1e-4, help="default: 1e-7"
        )
        sub_parser.add_argument(
            "--lr", type=float, default=0.0005, help="default: 0.002"
        )
        sub_parser.add_argument(
            "--epochs", type=int, default=500, help="default: 500"
        )
        sub_parser.add_argument(
    ...
    elif model == "ERPP" or model == "SPNPP":
        # add sub-parsers for each individual model
        sub_parser = subparsers.add_parser(
            model, help="Explainable Recurrent Point Process"
        )
        ...
        sub_parser.add_argument(
            "--batch_size", type=int, default=32, help="default: 64"
        )
        sub_parser.add_argument(
            "--dropout", type=float, default=0.0, help="default: 0.0"
        )
        sub_parser.add_argument(
            "--lr", type=float, default=0.0015, help="default: 0.001"
        )
        sub_parser.add_argument(
            "--epochs", type=int, default=500, help="default: 200"
        )
        sub_parser.add_argument(
            "--optimizer", type=str, default="Adam", help="default: Adam"
        )
        sub_parser.add_argument(
            "--l2_reg", type=float, default=0.0, help="default: 0"
        )
        sub_parser.add_argument(
            "--num_workers", type=int, default=0, help="default: 0"
        )
        ...
        sub_parser.add_argument(
            "--solver", type=str, default='agd', help="Default: agd, options: 'gd', 'agd', 'bfgs', 'svrg'"
        )
        sub_parser.add_argument(
